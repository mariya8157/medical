...
import '../order_repository/address_repository.dart';

final AddressControllerProvider = Provider((ref) =>
    AddressController(addressRepository: ref.watch(AddressRepositoryProvider)));
final StreamAddressProvider = StreamProvider(
    (ref) => ref.watch(AddressControllerProvider).StreamAddressData());

class AddressController {
  final AddressRepository _addressRepository;

  AddressController({required AddressRepository addressRepository})
