...
import '../home_repository/ambulance_repository.dart';

final AmbulanceControllerProvider = Provider((ref) => AmbulanceController(
    ambulanceRepository: ref.watch(AmbulanceRepositoryProvider)));
final StreamAmbulanceProvider = StreamProvider(
    (ref) => ref.watch(AmbulanceControllerProvider).StreamAmbulanceData());
